...
// judul
$pdf->Cell(190,7,'PEMROGRAMAN WEB C',0,1,'C');
$pdf->SetFont('Arial','B',12);
$pdf->Cell(190,7,'DAFTAR MAHASISWA KELAS PWEB C',0,1,'C');
...
//koneksi ke database
$mysqli = new mysqli("localhost","root","","fpdf_siswa");
$no = 1;
$tampil = mysqli_query($mysqli, "select * from siswapdf");
